...
<title>MU Shop</title>
<link rel="stylesheet"
	href="${contextPath}/resources/assets/css/500.css">
</head>

<body>
	<div class="main-error-page">
		<svg xmlns="http://www.w3.org/2000/svg"
			xmlns:xlink="http://www.w3.org/1999/xlink" width="auto" height="290"
			viewBox="0 0 470 290">
          <defs>
            <path id="prefix__a"
          ...
          <g fill="none" fill-rule="evenodd">
            <path fill="#FFF" d="M0 0H1366V800H0z"
            ...
            <g>
              ...
              <path class="fio-500" stroke="#2D3F5B"
              ...
              <path class="fio" stroke="#2D3F5B" stroke-linecap="round"
				stroke-width="4"
              ...
              <g class="raios" stroke="#fdba55" stroke-linecap="round"
				stroke-width="1.8">
                <path
		...
		<h2 class="error-subtitle">Have you tried turning it off and on
			again?</h2>
